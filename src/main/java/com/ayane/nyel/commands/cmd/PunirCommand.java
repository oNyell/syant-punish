...
import com.ayane.nyel.util.Webhook;
...
public class PunirCommand extends Commands {
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        if (!player.hasPermission("ayane.cmd.punir")) {
        ...
        if (args.length == 2) {
            ...
            if (sender.hasPermission("ayane.punish.proof")) {
    ...
    private static void apply(Punish punish, ProxiedPlayer target, String staffer) {
        ...
        ProxyServer.getInstance().getPlayers().stream().filter(o -> o.hasPermission("ayane.cmd.punir")).forEach(o -> {
