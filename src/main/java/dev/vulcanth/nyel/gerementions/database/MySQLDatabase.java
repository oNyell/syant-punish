package dev.vulcanth.nyel.gerementions.database;
...
public class MySQLDatabase extends Database {
    ...
    public MySQLDatabase() {
        ...
        openConnection();
        update("CREATE TABLE IF NOT EXISTS `syant-punish` (`id` VARCHAR(6), `playerName` VARCHAR(16), `stafferName` VARCHAR(16), `reason` TEXT, `type` TEXT, `proof` TEXT, `date` BIGINT(100), `expires` LONG, PRIMARY KEY(`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin;");
    }
